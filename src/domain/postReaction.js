...
export const unsetReactionPostDb = (postId, userId) =>
  postReactionDb(postId, userId, REACTIONS.unset)
export const likePostDb = (postId, userId) =>
  postReactionDb(postId, userId, REACTIONS.like)
